        ...
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="flex items-center space-x-3 group">
            <img
              src="/logo.png"
              alt="Denguess Logo"
              className="h-9 md:h-11 w-auto object-contain drop-shadow-sm group-hover:scale-105 transition-transform duration-300"
              loading="eager"
              onLoad={() => console.log('Navbar logo loaded from /logo.png')}
              onError={(e) => {
                console.error('Navbar logo failed to load:', e)
              }}
            />
            <motion.span
              className="text-xl md:text-2xl font-bold text-gray-900 group-hover:text-[#D64541] transition-colors"
